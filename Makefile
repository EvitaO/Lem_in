...
#    Updated: 2020/06/11 11:37:24 by eutrodri      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
SRCS = count_ants.c lem_in.c read_links.c read_rooms.c\
	 ...
	 sort_all.c algo_d.c put_link_off.c free2.c ft_atoi2.c
...
OBJ = count_ants.o lem_in.o read_links.o read_rooms.o\
	 ...
	 sort_all.o algo_d.o put_link_off.o free2.o ft_atoi2.o
